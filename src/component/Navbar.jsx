...
const Navbar = () => {
 ...
 const handleLogout=()=>{
  ...
  return (
    <div className=' flex justify-between items-center bg-slate-600 w-[95%] m-auto h-[10vh] font-montelugra p-5'>
      <div className=' text-seconColor font-extrabold uppercase'>Clarus News</div>
      <div className='flex justify-between gap-6'>
      {user && <span className=' text-thirdColor'>Welcome {user.text}</span>}
      <button onClick={handleLogout} className=' text-seconColor'>Logout</button>
...
//     )
// }
// user.test yazınca bilgiyi aldı
;
